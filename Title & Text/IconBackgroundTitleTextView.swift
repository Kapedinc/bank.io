//
//  IconBackgroundTitleTextView.swift
//  Bank.io
//

import SwiftUI

struct IconBackgroundTitleTextView: View {
...
private extension IconBackgroundTitleTextView {
    @ViewBuilder
...
struct IconBackgroundTitleTextView_Previews: PreviewProvider {
